...
export default function GenericForm({
  ...
  return (
	<div className="flex w-full ">
		...
		>
			<div className="py-4 px-10 h-full flex flex-col gap-2 items-start" style={styles.formStyles}>
			<h2 className="w-full text-3xl font-extrabold mb-4 text-left">{formTitle}</h2>
			<p className="mb-4">Fill out the form below and our sales representative will call you to confirm your installation spot.</p>
			<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
				{parsedFormFields.map((field) => (
					...
					render={({ field: fieldController }) => (
						<FormItem className={`w-full flex flex-col ${field.type === 'textarea' || field.name === 'address' ? 'col-span-2' : 'col-span-1'}`}>
						<FormLabel
			...
			<button
				type="submit"
				className="font-bold w-1/2 mt-4 px-4 py-3 text-white rounded"
